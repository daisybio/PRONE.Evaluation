...
data <- fread("data/raw_real_world_files/CPTAC_OV/TMT_CPTAC_MaxQuant/JHU_output/proteinGroups.txt")


# Original publication -> design
design <- read_excel("data/raw_real_world_files/CPTAC_OV/original_publication/NIHMS1668244-supplement-Table_S1.xlsx", sheet = "Experimental Design")
...
clinical <- read_excel("data/raw_real_world_files/CPTAC_OV/original_publication/NIHMS1668244-supplement-Table_S1.xlsx", sheet = "Clinical Information")
...
md <- md[!md$Sample_ID %in% c("SPL 039", "SPL 047")]
